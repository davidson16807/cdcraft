...
*/
const UrlArrows = (dependencies, settings) => {
    ...
    settings = settings || {};
    const min_length_clockwise_precision = settings.min_length_clockwise_precision || 0.0005;
    ...
    return {
        ...
        export: (arrow) => 
            url_arrays.export([
                ...
                url_floats(0,min_length_clockwise_precision).export(arrow.arc.min_length_clockwise),
        ...
        import: (string) => 
            (array => new DiagramArrow(
                new StoredArc(
                    ...
                    url_floats(0,min_length_clockwise_precision).import(array[3]),
