...
def BasicParsingExpressionGrammarPrimitives(maybes, maps, maybe_maps, states):
...
def ExtendedParsingExpressionGrammarPrimitives(lists, peg):
    Object.assign({}, 
        peg,
        {
            repeat:
...
def ShorthandParsingExpressionGrammarPrimitives(maps, peg):
    const type_lookups = {}
