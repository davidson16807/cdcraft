...
function CurriedUserArcsAndPointArcs(curried_node_point_indication) {
    return (arrows) => {
            ...
            user_arcs_and_flat_arcs.user_arc_to_flat_arc = (user_arc) => 
                new PointArc(
                    curried_node_point_indication(user_arcs_and_flat_arcs, arrows).point(user_arc.source),
                    curried_node_point_indication(user_arcs_and_flat_arcs, arrows).point(user_arc.target),
